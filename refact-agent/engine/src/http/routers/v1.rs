...
use crate::http::routers::v1::c2000_config::handle_v1_c2000_config;
use crate::http::routers::v1::esp32_config::handle_v1_esp32_config;
use crate::http::routers::v1::esp32_factory_release::handle_v1_esp32_factory_release;
use crate::http::routers::v1::esp32_project_workspace::handle_v1_esp32_create_project_workspace;
use crate::http::routers::v1::esp32_project_sources::{
    handle_v1_esp32_project_sources_list,
...
use crate::http::routers::v1::workflow::{
    ...
    handle_v1_workflow_pause, handle_v1_workflow_resume, handle_v1_workflow_task_add,
    handle_v1_workflow_task_action, handle_v1_workflow_history, handle_v1_workflow_events,
    handle_v1_workflow_summary,
};
...
pub fn make_v1_router() -> Router {
    let builder = Router::new()
        ...
        .route("/chat-payload-debug", post(handle_v1_chat_payload_debug))  // debug endpoint to see exact LLM payload
        ...
        .route("/c2000-config", get(handle_v1_c2000_config))
        .route("/esp32-config", get(handle_v1_esp32_config))
        .route("/esp32/factory-release", get(handle_v1_esp32_factory_release))
        .route("/esp32/create-project-workspace", post(handle_v1_esp32_create_project_workspace))
        ...
        .route("/workflow", get(handle_v1_workflow_get))
        .route("/workflow", post(handle_v1_workflow_create))
        .route("/workflow", delete(handle_v1_workflow_cancel))
        .route("/workflow/pause", post(handle_v1_workflow_pause))
        .route("/workflow/resume", post(handle_v1_workflow_resume))
        .route("/workflow/tasks", post(handle_v1_workflow_task_add))
        .route("/workflow/tasks/:task_id/action", post(handle_v1_workflow_task_action))
        .route("/workflow/history", get(handle_v1_workflow_history))
        .route("/workflow/events", get(handle_v1_workflow_events))
        .route("/workflow/summary", get(handle_v1_workflow_summary))
