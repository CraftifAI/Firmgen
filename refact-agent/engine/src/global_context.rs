...
use crate::workflow::{SharedWorkflowEngine, create_workflow_engine};
...
pub struct CommandLine {
    ...
    #[structopt(long, help="(Legacy) Use dynamic vector database. Prefer --static-vecdb instead.")]
    pub vecdb: bool,
    #[structopt(long, default_value="15000", help="(Legacy) Maximum files count for VecDB index.")]
    pub vecdb_max_files: usize,
    #[structopt(long, default_value="", help="(Legacy) Set VecDB storage path manually.")]
    pub vecdb_force_path: String,
    #[structopt(long, help="(Legacy) Wait until VecDB is ready before responding requests.")]
    pub wait_vecdb: bool,

    #[structopt(long, default_value="", help="Build a static VecDB from the specified directory, then exit. Use with --output.")]
    pub build_static_vecdb: String,
    #[structopt(long, default_value="", help="Output file path for --build-static-vecdb.")]
    pub output: String,
    #[structopt(long, help="Load static VecDB file(s). Can be specified multiple times.")]
    pub static_vecdb: Vec<String>,
    #[structopt(long, help="Board definition ID to pre-load (e.g., esp32-s3-devkitc-1-n32r8v). Board definition will be available throughout the session.")]
    pub board_definition: String,
    ...
    #[structopt(long, default_value="", help="Enable embedded platform tools: c2000, esp32, or both (comma-separated)")]
    pub platform: String,
}
...
pub struct GlobalContext {
    ...
    pub static_vec_db: Arc<AMutex<crate::vecdb::vdb_static::MultiStaticVecDb>>,
    ...
    pub workflow_engine: SharedWorkflowEngine,
}
...
pub async fn create_global_context(
    ...
    let cx = GlobalContext {
        ...
        static_vec_db: Arc::new(AMutex::new(crate::vecdb::vdb_static::MultiStaticVecDb::new())),
        ast_service: None,
