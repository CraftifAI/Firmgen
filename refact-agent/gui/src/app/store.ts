...
import { workspaceProjectsSlice } from "../features/WorkspaceProjects/workspaceProjectsSlice";
...
const rootReducer = combineSlices(
  {
    ...
    workspaceProjects: workspaceProjectsSlice.reducer,
  },
  historySlice,
  errorSlice,
  informationSlice,
...
const rootPersistConfig = {
  key: "root",
  storage: storage(),
  whitelist: [historySlice.reducerPath, "tour", userSurveySlice.reducerPath, "workspaceProjects"],
  stateReconciler: mergeInitialState,
};
