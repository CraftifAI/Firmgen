    ...
    if (optionValue === "tokens" && meteringTokens && totalMetering !== null) {
      ...
      return (
        <Flex direction="column" gap="4">
          ...
          />
          {subchatUsage && (
            <Flex direction="column" gap="2" pt="3" style={{ borderTop: "1px solid var(--gray-6)" }}>
              <Text size="2" color="gray">Subchat tokens (offloaded from main context):</Text>
              <TokenDisplay label="Subchat prompt" value={subchatUsage.prompt_tokens} />
              <TokenDisplay label="Subchat completion" value={subchatUsage.completion_tokens} />
            </Flex>
          )}
        </Flex>
      );
      ...
      return (
        <Flex direction="column" gap="4">
          ...
          {subchatUsage && (
            <Flex direction="column" gap="2" pt="3" style={{ borderTop: "1px solid var(--gray-6)" }}>
              <Text size="2" color="gray">Subchat tokens (offloaded from main context):</Text>
              <TokenDisplay label="Subchat prompt tokens" value={subchatUsage.prompt_tokens} />
              <TokenDisplay label="Subchat completion tokens" value={subchatUsage.completion_tokens} />
            </Flex>
          )}
        </Flex>
      );
...
const DefaultHoverTriggerContent: React.FC<{
  ...
  return (
    <>
      ...
      {subchatUsage && (
        <Flex align="center" style={{ marginLeft: "4px" }}>
          <Text size="1" color="gray">
            [⚡️ {formatNumberToFixed(subchatUsage.prompt_tokens + subchatUsage.completion_tokens)}]
          </Text>
        </Flex>
      )}
    </>
