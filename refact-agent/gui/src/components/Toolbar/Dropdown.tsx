  ...
  return (
    <Box
      style={{
        ...
        display: trigger ? "flex" : "inline-flex",
        width: trigger ? "100%" : undefined,
        minWidth: trigger ? 0 : undefined,
        alignItems: "center",
        transform: trigger ? undefined : "translateY(-4px)",
        marginBottom: "5px",
      }}
    >
        ...
        {trigger ? (
          ...
          <DropdownMenu.Trigger>
            <IconButton
              ...
              className={craftifPanelBtn.settingsTrigger}
            >
              <FiShare width={16} height={16} aria-hidden />
            </IconButton>
          </DropdownMenu.Trigger>
        )}
