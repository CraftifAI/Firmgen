      ...
      <Flex gap="2" align="center">
        ...
        <HoverCard.Root>
          ...
          <HoverCard.Content side="top" align="end" size="1" maxWidth="280px">
            ...
            <Text as="p" size="1">
              When enabled, CraftifAI Agent will automatically apply changes to
            ...
            <Text as="p" size="1">
              When disabled, CraftifAI Agent will ask for your confirmation before
        ...
        <HoverCard.Root>
          ...
          <HoverCard.Content side="top" align="end" size="1" maxWidth="280px">
            <Flex direction="column" gap="2">
              <Text as="p" size="1">
                When enabled, CraftifAI Agent will automatically make snapshots of
      ...
      <Flex gap="2" align="center">
        ...
        <HoverCard.Root>
          ...
          <HoverCard.Content side="top" align="end" size="1" maxWidth="280px">
            <Flex direction="column" gap="2">
              <Text as="p" size="1">
                When enabled, CraftifAI Agent will automatically generate related
      ...
      <Flex gap="2" align="center">
        ...
        <HoverCard.Root>
          ...
          <HoverCard.Content side="top" align="end" size="1" maxWidth="280px">
            <Flex direction="column" gap="2">
              <Text as="p" size="1">
                When enabled, CraftifAI Agent will automatically generate
      ...
      {host !== "web" && (
        ...
        >
          <Flex align="center" gap="1">
            <FilePlusIcon />
            <Text size="1">Attach: {attachedFiles.activeFile.name}</Text>
          </Flex>
        </Button>
      )}
