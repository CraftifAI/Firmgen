...
let XBAR_InputNum = [
	{ name: "XBAR_INPUT1", displayName: "PWM[TZ1], PWM[TRIP1], X-BARs, eCAPs" },
	{ name: "XBAR_INPUT2", displayName: "PWM[TZ2], PWM[TRIP2], X-BARs, eCAPs" },
	{ name: "XBAR_INPUT3", displayName: "PWM[TZ3], PWM[TRIP3], X-BARs, eCAPs" },
	{ name: "XBAR_INPUT4", displayName: "ADC wrappers, X-BARs, XINT1, eCAPs" },
	{ name: "XBAR_INPUT5", displayName: "EXTSYNCIN1, X-BARs, XINT2, eCAPs" },
	{ name: "XBAR_INPUT6", displayName: "EXTSYNCIN2, PWM[TRIP6], X-BARs, XINT3, eCAPs" },
