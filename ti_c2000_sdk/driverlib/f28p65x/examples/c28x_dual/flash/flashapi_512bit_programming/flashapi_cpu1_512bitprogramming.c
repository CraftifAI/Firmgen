//#############################################################################
//
// FILE:   flashapi_cpu1_512bitprogramming.c
//
...
void main(void)
{
    ...
    // Set the GSxMSEL register for CPU2
    EALLOW;
    MemCfg_unlockConfig(MEMCFG_SECT_GSX_ALL);
    MemCfg_setGSRAMControllerSel(MEMCFG_SECT_GSX_ALL, MEMCFG_GSRAMCONTROLLER_CPU2);

    // Set the Banks for CPU2
    SysCtl_allocateFlashBank(SYSCTL_FLASH_BANK1, SYSCTL_CPUSEL_CPU2);
    SysCtl_allocateFlashBank(SYSCTL_FLASH_BANK2, SYSCTL_CPUSEL_CPU2);
...
void Example_ProgramAllBankUsing512bitAutoECC(void)
{
    ...
    //
    // In this example, all Flash Bank are programmed using auto-generated
    // ECC.
    //
...
void Example_ProgramAllBankUsing512bitDataOnlyECCOnly(void)
{
    ...
    // reasons.
    //
    // In this example, Bank 0-4 are programmed
...
void Example_ProgramAllBankUsing512bitDataAndECC(void)
{
    ...
    // reasons.
    //
    // In this example, Bank0-4 are programmed in Flash
    // along with the specified ECC.
    //
    //Program Bank 0
   for(sector = Bzero_Sector12_start; sector < FlashBank0EndAddress;
