...
//#############################################################################
//
// FILE:   F28P65x_EEPROM_PingPong_Example.c
//
//#############################################################################


#include "EEPROM_PingPong_Config.h"
#include <stdio.h>
...
void main(void)
{
    ...
    // to display full functionality (fill, erase, fill, erase)
    Loop_Limit = ((NUM_EEPROM_SECTORS * FLASH_SECTOR_SIZE) / 2) + 1;
    ...
    // Initialize loop limit that will allow the EEPROM to show full functionality (fill, erase, fill, erase)
